...
- **[List-O-Mania](docs/List-O-Mania/)** - Research topics and architectural patterns under investigation
...
- **[Apache Calcite](https://calcite.apache.org/)** - SQL query engine and optimizer
- **[Eclipse Jetty](https://www.eclipse.org/jetty/)** - High-performance HTTP server
