...
<dependencies>
    ...
    <!-- Federated SQL over JDBC, Arrow, CSV, file, Redis, Kafka, and other Calcite sources -->
    <dependency>
        <groupId>io.cheshire</groupId>
...
| **cheshire-query-engine-calcite** | Apache Calcite federation over JDBC, Arrow, CSV, file, Cassandra, InnoDB, OS, Redis, Kafka, and plugin-backed MAT sources |
| **cheshire-source-provider-jdbc** | JDBC data source provider with connection management |
| **cheshire-source-provider-elasticsearch** | Elasticsearch source provider backed by JDK HTTP |
