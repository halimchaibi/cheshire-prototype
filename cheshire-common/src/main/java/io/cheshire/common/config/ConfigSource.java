 ...
 * <p>
 * Provides unified API for loading configuration files from different sources
 * with security validation and path resolution.
 * <p>
 ...
 * <p>
 * Filesystem implementation validates paths to prevent directory traversal attacks.
 * All resolved paths must be within the specified root directory.
 * <p>
 * <strong>Sealed Interface:</strong>
 * <p>
 * Java 21 sealed interface restricts implementations to Classpath and Filesystem,
 * enabling exhaustive pattern matching and preventing uncontrolled extension.
 *
 * @see ConfigLoader
...
public sealed interface ConfigSource
        permits ConfigSource.Classpath, ConfigSource.Filesystem {
