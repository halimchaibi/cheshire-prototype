 ...
 * <p>
 * Provides unified API for loading configuration files from different sources with security validation and path
 * resolution.
 * <p>
 * <strong>Implementations:</strong>
 * <ul>
 * <li><strong>Classpath:</strong> Loads from classpath resources (e.g., jar files)</li>
 * <li><strong>Filesystem:</strong> Loads from filesystem with directory traversal protection</li>
 * </ul>
 * <p>
 ...
 * <p>
 * Filesystem implementation validates paths to prevent directory traversal attacks. All resolved paths must be within
 * the specified root directory.
 * <p>
 * <strong>Sealed Interface:</strong>
 * <p>
 * Java 21 sealed interface restricts implementations to Classpath and Filesystem, enabling exhaustive pattern matching
 * and preventing uncontrolled extension.
 *
 * @see ConfigLoader
...
public sealed interface ConfigSource permits ConfigSource.Classpath, ConfigSource.Filesystem {
     ...
     *
     * @param root
     *            root package path (e.g., "config", "com/app/config")
     ...
     *             if path not found or access denied
     */
    ...
    final class Classpath implements ConfigSource {
        ...
        public InputStream open(String path) {
            ...
            if (in == null) {
                throw new io.cheshire.common.config.ConfigurationException("Config not found on classpath: " + full);
            }
            return in;
        }
