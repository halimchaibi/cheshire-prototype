...
public final class ConfigurationUtils {
    ...
    /**
     * Deep copy a configuration object using Jackson.
     * Used for:
     * - Defensive copies (SpotBugs EI_EXPOSE_RE)
     * - Test isolation
     * - Safe exposure of mutable config graphs
     *
    ...
    public static <T> T deepCopy(T source, Class<T> type) {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Failed to deep copy configuration object of type " + type.getName(),
                    e
            );
        }
    }
    ...
    public static Properties loadProperties(String resourcePath) {
        ...
        try (InputStream input =
                     ConfigurationUtils.class.getClassLoader().getResourceAsStream(resourcePath)) {
            ...
            throw new ConfigurationException(
                    "Failed to load properties from " + resourcePath, e
            );
        }
    }
