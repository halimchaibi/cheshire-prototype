 ...
 * Unlike {@link io.cheshire.core.server.protocol.RequestContext}, which is ephemeral and scoped to a single
 * request-response cycle, SessionContext persists across multiple distinct actions within the same session.</p>
 *
 ...
 * SessionContext instance with modified attributes (copy-on-write pattern).</li>
 ...
 * <table border="1">
 * <tr><th>Aspect</th><th>SessionContext</th><th>RequestContext</th></tr>
...
public record SessionContext(
     ...
     */
    public SessionContext(String sessionId, String userId, String traceId,
                          Map<String, Object> securityContext,
                          ConcurrentMap<String, Object> attributes,
                          Instant arrivalTime,
                          Instant deadline) {
