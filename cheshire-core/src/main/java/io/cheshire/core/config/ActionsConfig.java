 ...
 * <p>
 * This class represents the structure of an MCP actions file (e.g., {@code blog-actions.yaml}),
...
public class ActionsConfig {
     ...
     * <p>
     * Tools map to business operations (CRUD, search, etc.) and are exposed
     * as REST endpoints or MCP tools depending on the exposure type.
     * <p>
     ...
     * <p>
     * Resources provide read-only access to configuration, metadata,
     ...
     * <p>
     * Prompts provide pre-defined templates that can be filled with
     * arguments for consistent LLM interactions.
     */
