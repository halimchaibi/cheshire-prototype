 ...
 *
 * <p>This class represents the structure of an MCP actions file (e.g., {@code blog-actions.yaml}),
 * which defines the tools, resources, prompts, and schemas exposed by a capability.
 *
 * <p><strong>MCP Concepts:</strong>
 *
 * <ul>
 *   <li><strong>Tools:</strong> Invocable operations (e.g., createAuthor, listArticles)
 *   <li><strong>Resources:</strong> Static data endpoints (e.g., configuration, metadata)
 *   <li><strong>Resource Templates:</strong> Parameterized resource URIs
 *   <li><strong>Prompts:</strong> Pre-defined prompt templates for LLM interactions
 *   <li><strong>Schemas:</strong> Reusable JSON schemas for input validation
 * </ul>
 *
 ...
 *   <li>Referenced from {@link CheshireConfig.Capability} via {@code actions-specification-file}
 *   <li>Merged into capability configuration
 *   <li>Used by protocol adapters (REST, MCP) to expose operations
 * </ol>
 *
...
public class ActionsConfig {
   ...
   *
   * <p>Tools map to business operations (CRUD, search, etc.) and are exposed as REST endpoints or
   * MCP tools depending on the exposure type.
   *
   ...
   *
   * <p>Resources provide read-only access to configuration, metadata, or other static information.
   */
   ...
   *
   * <p>Allows dynamic resource paths with placeholders.
   *
   * <p><strong>Example:</strong>
   *
   * <pre>{@code
   ...
   *
   * <p>Prompts provide pre-defined templates that can be filled with arguments for consistent LLM
   * interactions.
   */
   ...
   *
   * <p>Defines authentication, rate limiting, and caching policies.
   */
