 ...
 * <p>
 * This enum defines a canonical set of keys for accessing metadata in
 * contexts, requests, and internal data structures. It ensures type-safe,
 * consistent key usage across the framework.
 * <p>
 ...
 * The {@link #from(String)} method performs case-insensitive lookup,
 * allowing flexible parsing from configuration or external sources.
 *
...
public enum Key {
     ...
     * <p>
     * This method allows flexible parsing from configuration files,
     * HTTP headers, or other external sources where case may vary.
     *
