 ...
 * <p>
 * A capability is a self-contained business domain that federates data sources,
 * actions (tools/endpoints), and processing pipelines. Examples: "Authors", "Articles",
 * "Comments".
 * <p>
 ...
 * This manager acts as a centralized registry allowing lookup of capabilities by name.
 * It's used throughout the framework to:
 * <ul>
 ...
 * </ul>
 * <p>
 * <strong>Singleton Behavior:</strong>
 * Implemented as an atomic singleton to ensure consistent global state across
 * the application. First initialization requires {@link CheshireConfig}.
 * <p>
...
public final class CapabilityManager implements Initializable {
    ...
    private final Registry<Capability> registry = new Registry<>(
        "Capability",
        capability -> {
            try {
                clear();
     ...
     * </ol>
     * <p>
     * <strong>Note:</strong> Contains a TODO for improving source and query
    ...
    private Map<String, PipelineProcessor<CanonicalInput<?>, CanonicalOutput<?>>>  resolvePipelines(CheshireConfig.Capability def) {
        try {
                    ...
                    .collect(Collectors.toMap(
                            ...
                            e -> {
                                try {
                                    ...
                                    log.error("Pipeline '{}' in capability '{}' refers to a missing class: {}",
                                            e.getKey(), def.getName(), ex.getMessage());
     ...
     * <p>
     * This utility method safely extracts typed values from configuration maps,
     * providing clear error messages when types don't match.
     *
