 ...
 * <p>
 * ConfigurationManager is responsible for loading, resolving, validating, and safely
 * exposing Cheshire configuration from various sources (filesystem, classpath).
 * <p>
 ...
 * </pre>
 * <p>
 * <strong>File Resolution:</strong>
 * Main config file determined by (in order):
 * <ol>
 ...
 * Immutable after initialization. {@link #getCheshireConfig()} returns defensive copies.
 *
 * @see CheshireConfig
 * @see ConfigLoader
 * @see ConfigSource
...
public final class ConfigurationManager {
    ...
    public ConfigurationManager(ConfigSource source) {
        ...
        this.source = source;
        this.cheshireConfig =
                loader.load(source, configFile, CheshireConfig.class);
        initialize();
    }
     ...
     * <p>
     * This constructor is used for testing and programmatic configuration where
     * YAML file loading is bypassed.
     * <p>
     * <strong>Note:</strong> No filesystem/classpath access. Capability references
     * (actions, pipelines) must be pre-populated in the config object.
     *
     ...
     * <p>
     * <strong>Why defensive copy?</strong>
     * Prevents external modification of internal configuration state. Required to
     * avoid SpotBugs warning EI_EXPOSE_REP (Exposing Internal Representation).
     * <p>
     * <strong>Performance Note:</strong>
     * This operation uses deep cloning via JSON serialization/deserialization.
     ...
     * <p>
     * Pipelines define the three-stage processing for each action:
    ...
    private Map<String, PipelineConfig> loadPipelinesDefinition(String path) {
        ...
        return loader.load(source, path,
                new TypeReference<Map<String, PipelineConfig>>() {
                });
    }
