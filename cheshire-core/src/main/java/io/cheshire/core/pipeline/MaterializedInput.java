 ...
 * <p>
 * Immutable input container for pipeline operations, carrying both the primary data and associated metadata through
 * pipeline stages.
 * </p>
 *
 ...
 *
 * @param data
 *            Immutable map containing the primary payload data.
 * @param metadata
 *            Immutable map containing contextual metadata.
...
public record MaterializedInput(Map<String, Object> data,
    ...
    public MaterializedInput {
        ...
        metadata = (metadata != null && !data.isEmpty()) ? new LinkedHashMap<>(metadata) : new LinkedHashMap<>();
    }
     ...
     * <p>
     * This method is required by {@link CanonicalInput} and enables pipeline stages to create modified versions without
