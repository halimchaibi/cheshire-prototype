 ...
 * <p>
 * The dispatcher sits between the network transport layer and the business logic,
 * acting as the orchestration point for request processing. It:
 * <ol>
 ...
 * <p>
 * The {@link #from(Capability, CheshireSession)} factory method selects the
 * appropriate dispatcher implementation based on the capability's exposure binding.
 * <p>
...
public sealed interface CheshireDispatcher
     ...
     */
    static CheshireDispatcher from(
            Capability capability,
            CheshireSession session
    ) {
     ...
     * Exceptions during processing are caught and returned as error responses
