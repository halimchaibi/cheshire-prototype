 ...
 * <p>
 * A CheshireServer represents a running network service (HTTP server, stdio handler)
 * that exposes one or more capabilities to external clients. It manages the server
 * lifecycle and coordinates with the {@link CheshireDispatcher} for request processing.
 * <p>
 ...
 * <p>
 * Servers are created via {@link CheshireServerFactory} implementations loaded
 * through Java's SPI mechanism. The factory class name is specified in the
 * transport configuration.
 * <p>
 * <strong>Thread Safety:</strong>
 * <p>
 * Implementations must be thread-safe as lifecycle methods may be called from
 * different threads during startup/shutdown.
 *
...
public interface CheshireServer {
     ...
     * This method should return quickly. Long-running accept loops should
     ...
     * Implementations should attempt graceful shutdown with a reasonable timeout,
     ...
     * <p>
     * Used for logging, monitoring, and debugging to identify which
     * protocol/exposure this server implements.
     * <p>
     ...
     * <p>
     * Returns {@code true} only after {@link #start()} succeeds and before
     * {@link #stop()} is called.
     *
