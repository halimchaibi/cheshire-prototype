...
/**
 * Represents the physical network infrastructure (e.g., Jetty Engine, Netty Boss/Worker). It is responsible for the
 * socket lifecycle and thread management.
 */
public interface CheshireTransport {
    ...
    enum Binding {
        HTTP_JSON, MCP_JSON_RPC, MCP_STDIO;
