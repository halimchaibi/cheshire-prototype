 ...
 * ephemeral and scoped to a single request-response cycle, TaskContext persists across multiple
 ...
 *       TaskContext instance with modified attributes (copy-on-write pattern).
