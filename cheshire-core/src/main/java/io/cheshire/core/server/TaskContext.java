 ...
 * request-response cycle, TaskContext persists across multiple distinct actions within the same session.</p>
 *
 ...
 * TaskContext instance with modified attributes (copy-on-write pattern).</li>
 ...
 * <table border="1">
 * <tr><th>Aspect</th><th>TaskContext</th><th>RequestContext</th></tr>
...
public record TaskContext(
     ...
     */
    public TaskContext(String sessionId, String userId, String traceId,
                       Map<String, Object> securityContext,
                       ConcurrentMap<String, Object> attributes,
                       Instant arrivalTime,
                       Instant deadline) {
