 ...
 *
 * <p>A <b>Standardized Data Container</b> that decouples the physical message format (e.g., JSON,
 * XML) from the semantic business logic arguments. It acts as the "Body" of the {@code
 * RequestEnvelope}. *
 *
 * <h3>The Dual-Access Pattern</h3>
 *
 * <p>This record provides two ways to consume data:
 *
 * <ul>
 *   <li><b>Raw Access:</b> Via {@link #data()}, representing the fully parsed object (e.g., a POJO
 *       or JsonNode).
 *   <li><b>Key-Value Access:</b> Via {@link #parameters()}, facilitating quick access to flattened
 *       arguments, essential for MCP Tool calls and Form data.
 * </ul>
 *
 ...
 *       null fields are replaced with {@link #NO_DATA} or empty collections.
 *   <li><b>Defensive Storage:</b> Internal maps are defensively copied into {@link
 *       java.util.HashMap} during construction.
 * </ul>
 *
 * <pre>{@code
...
public record RequestPayload(
  ...
  public static RequestPayload of(
      PayloadType type,
      Object data,
      java.util.Map<String, Object> parameters,
      java.util.Map<String, Object> metadata) {
  ...
  public static RequestPayload of(
      java.util.Map<String, Object> parameters, java.util.Map<String, Object> metadata) {
  ...
  /**
   * Enumeration of supported payload formats. Ranges from structured data (JSON/XML) to RPC
   * protocols and low-level binary.
   */
