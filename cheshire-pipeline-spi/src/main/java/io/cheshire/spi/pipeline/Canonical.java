...
public sealed interface Canonical<S extends Canonical<S>> extends Iterable<Map.Entry<String, Object>> permits CanonicalInput, CanonicalOutput {
    /**
     * Access the data as a Map.
     * In streaming implementations, this returns a Lazy-view Map.
     */
    ...
    default <T> T require(String key, Class<T> type) {
        ...
        if (!type.isInstance(value)) {
            throw new IllegalArgumentException("Key [%s] is %s, but expected %s"
