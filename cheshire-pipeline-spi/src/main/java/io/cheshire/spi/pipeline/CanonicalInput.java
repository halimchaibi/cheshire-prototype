...
public non-sealed interface CanonicalInput<S extends CanonicalInput<S>> extends Canonical<S> {
  static <T extends CanonicalInput<T>> T create(
      Class<T> implementationClass, Map<String, Object> data, Map<String, Object> metadata) {
    ...
    try {
      ...
      throw new RuntimeException(
          "Implementation "
              ...
              + " must provide a (Map, Map) constructor.",
          e);
    }
  }
}
