 ...
 * persistent SSE stream). Unlike {@link io.cheshire.spi.pipeline.ExecutionContext}, which is
 * ephemeral and scoped to a single request-response cycle, ExecutionContext persists across
 * multiple distinct actions within the same session.
 *
 ...
 *       unmodifiable maps to prevent accidental modification. ExecutionContext instance with
 *       modified attributes (copy-on-write pattern).
...
public record ExecutionContext(
   ...
   *
   * <p>Creates a ExecutionContext with:
   *
