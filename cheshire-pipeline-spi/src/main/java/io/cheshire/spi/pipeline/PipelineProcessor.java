 ...
 * <p>
 * The {@link #executeAsync(CanonicalInput, Context)} method leverages Java's virtual threads
 * for non-blocking pipeline execution. This is experimental and subject to change.
 * <p>
 * <strong>Error Handling:</strong>
 * <p>
 * Any {@link PipelineException} thrown during execution propagates immediately, short-circuiting
            ...
            )
{
     ...
     * <pre>{@code
     * I processedInput = preProcessors.stream()
     *     .reduce(input,
     *         (in, processor) -> processor.apply(in, ctx),
     *         (a, b) -> b);
     * }</pre>
     * The combiner {@code (a, b) -> b} is unused in sequential streams but required by API.
     * <p>
     * <strong>Error Propagation:</strong>
     * Any {@link PipelineException} thrown by a step immediately terminates execution
     ...
     * <p>
     * <b>Note:</b> This method is currently <b>experimental</b>.
     * The resource management of the underlying executor is subject to change.
     * </p>
     *
