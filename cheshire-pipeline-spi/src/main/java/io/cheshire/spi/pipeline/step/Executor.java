 ...
 * <p>
 * The Executor is the heart of the pipeline, responsible for executing the primary business operation. It transforms
 * {@link CanonicalInput} into {@link CanonicalOutput}, typically by:
 * <ul>
 ...
 * <p>
 * Unlike preprocessors and postprocessors (which can be chained), each pipeline has exactly ONE executor. This enforces
 ...
 * <p>
 * Unlike preprocessors/postprocessors which preserve types ({@code I → I}, {@code O → O}), executors transform types
 * ({@code I → O}), reflecting the fundamental business transformation.
 * <p>
 ...
 * <p>
 * Executors should throw {@link io.cheshire.spi.pipeline.exception.PipelineException} or its subclasses for business
 * logic failures. These exceptions are caught by the dispatcher and converted to appropriate error responses.
 *
 * @param <I>
