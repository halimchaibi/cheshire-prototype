...
/**
 * Factory for creating Executor instances. Implement this interface and register via ServiceLoader.
 */
public non-sealed interface ExecutorFactory<I extends CanonicalInput<?>, O extends CanonicalOutput<?>>
        extends StepFactory<Executor<I, O>> {
