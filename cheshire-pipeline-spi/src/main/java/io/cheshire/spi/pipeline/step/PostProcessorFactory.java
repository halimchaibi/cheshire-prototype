...
/**
 * Factory for creating PostProcessor instances. Implement this interface and register via ServiceLoader.
 */
public non-sealed interface PostProcessorFactory<O extends CanonicalOutput<?>> extends StepFactory<PostProcessor<O>> {
