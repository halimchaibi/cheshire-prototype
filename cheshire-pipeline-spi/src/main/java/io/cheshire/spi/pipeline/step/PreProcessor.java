 ...
 * <p>
 * PreProcessors prepare and validate input before it reaches the executor. They transform {@link CanonicalInput} to
 * {@link CanonicalInput}, enriching or normalizing data as needed.
 * <p>
 ...
 * <p>
 * Multiple preprocessors execute sequentially, each receiving the output of the previous one:
 *
 * <pre>
 ...
 * <p>
 * Input and output types are the same ({@code I → I}), ensuring type safety through the preprocessing chain.
 *
 * @param <I>
