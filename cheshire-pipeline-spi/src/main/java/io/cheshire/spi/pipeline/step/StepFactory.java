...
public sealed interface StepFactory<S extends Step<?, ?>>
    ...
    /**
     * Description of what this step does /** Loads all available PostProcessorFactory implementations using
     * ServiceLoader
     *
     ...
     *
     * @param id
     *            The unique identifier of the PreProcessorFactory to find
     * @return The matching PreProcessorFactory instance
     * @throws PipelineException
     *             if no factory with the given ID is found
     */
