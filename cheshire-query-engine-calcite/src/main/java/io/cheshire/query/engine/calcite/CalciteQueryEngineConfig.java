 ...
 *
 * <p>
 * Sources listed here must be registered in the SourceProviderManager before the engine is opened.
 * </p>
 *
 * @param name
 *            the unique name/identifier for this query engine instance
 * @param sources
 *            the list of source names to register as Calcite schemas
