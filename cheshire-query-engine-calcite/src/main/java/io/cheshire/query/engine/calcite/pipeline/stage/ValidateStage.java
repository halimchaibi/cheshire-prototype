...
public final class ValidateStage implements PipelineStage<ParsedQuery, ValidatedQuery> {

  @Override
  public ValidatedQuery apply(final ParsedQuery input, final StageContext context)
      throws QueryExecutionException {
    try {
      return new ValidatedQuery(context.planner().validate(input.node()));
    } catch (Exception e) {
      throw new QueryExecutionException("Error during ValidateStage", e);
    }
  }
}
