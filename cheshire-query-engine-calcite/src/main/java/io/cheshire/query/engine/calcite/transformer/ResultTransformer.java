 ...
 * <p>
 * Converts Enumerator<Object[]> results from Calcite execution into
 * the MapQueryResult format expected by the query engine SPI.
 */
public class ResultTransformer {
     ...
     *
     * @param plan       the RelNode plan (for column metadata)
     * @param enumerator the enumerator containing row data
