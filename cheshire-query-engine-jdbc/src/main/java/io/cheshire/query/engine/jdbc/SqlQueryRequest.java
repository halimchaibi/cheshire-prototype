 ...
 *
 * <p>Wraps a SQL query string for execution by query engines that support SQL.
 * This is an immutable value object.</p>
 *
 * @param sql the SQL query string, must not be null
