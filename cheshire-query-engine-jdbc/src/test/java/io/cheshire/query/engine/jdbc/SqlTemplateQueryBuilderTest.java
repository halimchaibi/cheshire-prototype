...
/**
 * Sample tests for SqlTemplateQueryBuilder - critical SQL generation component.
 * Tests basic query building for SELECT, INSERT, UPDATE, DELETE operations.
 */
...
final class SqlTemplateQueryBuilderTest {
    ...
    final class ErrorHandlingTests {
        ...
        void shouldThrowExceptionForInvalidJson() {
            ...
            assertThatThrownBy(() ->
                SqlTemplateQueryBuilder.buildQuery(invalidTemplate, Map.of())
        ...
        void shouldThrowExceptionForMissingParameter() {
            ...
            assertThatThrownBy(() ->
                SqlTemplateQueryBuilder.buildQuery(template, Map.of())
            ).isInstanceOf(QueryEngineException.class);
        }
    }
}
