 ...
 *
 * <p>Implementations of this interface provide configuration data for query engine
 * instances. Configuration typically includes:
 * <ul>
 ...
 * </p>
 *
 * <p>Configuration objects should be immutable and validated before use.</p>
 *
...
public interface QueryEngineConfig {
     ...
     *
     * <p>This method provides a generic representation of the configuration,
     * useful for serialization, logging, and debugging.</p>
     *
