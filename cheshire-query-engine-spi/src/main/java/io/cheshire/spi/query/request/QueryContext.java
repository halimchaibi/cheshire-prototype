 ...
 * {@link io.cheshire.spi.query.request.QueryContext}, which is ephemeral and scoped to a single request-response cycle,
 * QueryContext persists across multiple distinct actions within the same session.
 * </p>
 *
 ...
 * prevent accidental modification.</li> QueryContext instance with modified attributes (copy-on-write pattern).</li>
 ...
 * QueryContext session = QueryContext.empty();
 *
 ...
 * }</pre>
 *
 * <h3>QueryContext vs QueryContext</h3>
 * <table border="1">
 * <tr>
 * <th>Aspect</th>
 * <th>QueryContext</th>
...
public record QueryContext(String sessionId, String userId, String traceId, Map<String, Object> securityContext,
     ...
     */
    public QueryContext(String sessionId, String userId, String traceId, Map<String, Object> securityContext,
            ConcurrentMap<String, Object> attributes, Instant arrivalTime, Instant deadline) {
     ...
     * Modifications to the returned map will <b>not</b> affect the internal state of this QueryContext.
     * </p>
     * <p>
