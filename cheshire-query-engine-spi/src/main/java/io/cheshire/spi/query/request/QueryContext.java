 ...
 * Unlike {@link io.cheshire.spi.query.request.QueryContext}, which is ephemeral and scoped to a single
 * request-response cycle, QueryContext persists across multiple distinct actions within the same session.</p>
 *
 ...
 * QueryContext instance with modified attributes (copy-on-write pattern).</li>
 ...
 * <table border="1">
 * <tr><th>Aspect</th><th>QueryContext</th><th>QueryContext</th></tr>
...
public record QueryContext(
     ...
     */
    public QueryContext(String sessionId, String userId, String traceId,
                        Map<String, Object> securityContext,
                        ConcurrentMap<String, Object> attributes,
                        Instant arrivalTime,
                        Instant deadline) {
     ...
     * affect the internal state of this QueryContext.
     * </p>
     * <p>
