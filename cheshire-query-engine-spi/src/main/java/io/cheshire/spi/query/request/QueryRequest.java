 ...
 *
 * <p>Represents a query request for any query engine type. The request payload
 * type is parameterized to support different query formats:
 * <ul>
 ...
 * </p>
 *
 * <p>Implementations should be immutable value objects.</p>
 *
 * @param <T> the type of the query payload (e.g., String for SQL, Map for JSON queries)
...
public interface QueryRequest<Q, P> {
     ...
     *
     * <p>The content type depends on the query engine:
     * <ul>
