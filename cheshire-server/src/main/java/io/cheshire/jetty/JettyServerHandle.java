 ...
 * <p>
 * Represents the logical service layer ("The Tenant"). Owns the capability-specific dispatcher and API paths. Delegates
 * physical server operations to the shared {@link JettyServerContainer}.
 * <p>
 ...
 * <p>
 * Multiple handles can share a single container (port), each serving different capabilities at different paths.
 *
 * @see CheshireServer
...
public final class JettyServerHandle implements CheshireServer {
     ...
     * <p>
     * This phase should include loading the {@code CheshireConfig}, initializing the {@code ProtocolAdapter}, and
     * setting up internal handlers. No network ports should be opened during this phase.
     * </p>
     *
     * @throws Exception
     *             if configuration is invalid or required resources are unavailable.
     */
    @Override
