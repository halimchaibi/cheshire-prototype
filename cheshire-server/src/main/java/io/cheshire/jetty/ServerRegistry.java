 ...
 * <p>
 * Provides singleton transport instances keyed by port number, enabling multiple
 * capabilities to share a single HTTP server (Jetty instance) when configured
 * with the same port.
 * <p>
 ...
 * <p>
 * Uses {@link ConcurrentHashMap#computeIfAbsent} for atomic get-or-create operations.
 * Safe for concurrent capability initialization.
 * <p>
 * <strong>Lifecycle:</strong>
 * <p>
 * Containers are created lazily on first access and shared across capabilities.
 * Reference counting in {@link JettyServerContainer} manages actual shutdown.
 *
...
public class ServerRegistry {
     ...
     * <p>
     * Creates {@link JettyServerContainer} for network bindings (HTTP) keyed by port,
     * or dedicated {@link StdioServerContainer} for stdio bindings.
     *
