...
public final class JettyRestModule {
    ...
    /**
     * Creates and configures the ServletContextHandler for REST.
     * This matches your original logic but keeps it isolated.
     */
    public ServletContextHandler createHandler() {

        String baseUrl = exposure.getConfig().get("path") instanceof String path
                ? path
                : "/api/v1";
