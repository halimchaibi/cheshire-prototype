...
public final class RestAdapterServlet extends HttpServlet {
  ...
  public RestAdapterServlet(RestRequestHandler handler) {
  ...
  protected void service(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    try {
      // TODO: Note safe depends on path configuration for exposure: assumes
      // /api/v{version}/{capability}/{action}
          ...
          if (err != null) {
            errorBody.put(
                ...
                Map.of(
                    ...
                    "detail",
                    err.getMessage() != null ? err.getMessage() : "No detailed message"));
          }
