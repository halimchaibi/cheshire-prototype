...
public class RestProtocolAdapter implements ProtocolAdapter<HttpServletRequest, Map<String, Object>> {
    ...
    @Override
    public RequestEnvelope toRequestEnvelope(HttpServletRequest req, String capability) throws ProtocolAdapterException {
        try {
            ...
            RequestPayload payload = new RequestPayload(
                    ...
                    parseBody(req), // The raw data object
    ...
    public <T> T fromProcessingResult(HttpServletRequest request, ResponseEntity result) throws ProtocolAdapterException {
