...
public final class JettyMcpModule {
    ...
    public ServletContextHandler createHandler() {
        String baseUrl = capability.exposure().getConfig().get("path") instanceof String path
                ? path
                : "/mcp/v1";
        ...
        McpManifestRegistrar.of(capability, dispatcher, mcpServer, new McpProtocolAdapter())
                .register();
