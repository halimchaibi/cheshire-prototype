...
public final class JettyMcpModule {
  ...
  public ServletContextHandler createHandler() {
    String baseUrl =
        capability.exposure().getConfig().get("path") instanceof String path ? path : "/mcp/v1";
    ...
    HttpServletStreamableServerTransportProvider transport =
        HttpServletStreamableServerTransportProvider.builder()
            ...
            .contextExtractor(request -> request::getHeader)
            .build();
    ...
    // client of the api will use /mcp/v1/{capabilityName} as base path, capability is unique per
    // server
