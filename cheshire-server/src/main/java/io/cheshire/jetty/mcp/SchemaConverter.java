...
public class SchemaConverter {
    ...
    public static McpSchema.JsonSchema convertToJsonSchema(Map<String, Object> inputSchema) {
        ...
        try {
            ...
            return new McpSchema.JsonSchema(getStringValue(normalizedSchema, "type", "object"),
        ...
        if (schema.containsKey("properties") && !(schema.get("properties") instanceof Map)) {
            try {
                ...
                if (properties instanceof String) {
                    ...
                    Map<String, Object> parsed = objectMapper.readValue((String) properties,
            ...
            try {
                ...
                if (required instanceof String) {
                    ...
                    if (str.startsWith("[") && str.endsWith("]")) {
                        ...
                        List<String> list = Arrays.stream(str.split(",")).map(String::trim).filter(s -> !s.isEmpty())
                                .toList();
    ...
    @SuppressWarnings("unchecked")
    private static List<String> getListValue(Map<String, Object> map, String key, List<String> defaultValue) {
        Object value = map.get(key);
        if (value == null)
            return defaultValue;
    ...
    private static McpSchema.JsonSchema createDefaultJsonSchema() {
        return new McpSchema.JsonSchema("object", Map.of(), List.of(), null, Map.of(), Map.of());
    }
