 ...
 * <p>
 * Manages MCP server instances communicating via standard input/output streams.
 * Unlike HTTP transports, stdio transport supports only a single registered module.
 * <p>
 ...
 * <p>
 * Only one {@link McpAsyncServer} can be registered per stdio transport since
 * there's only one stdin/stdout pair. Attempting to register multiple modules
