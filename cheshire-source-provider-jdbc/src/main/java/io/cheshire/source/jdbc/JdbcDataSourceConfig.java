...
/**
 * Generic JDBC SourceConfigT implementation.
 * Holds all necessary information to create a JDBC connection.
 */
public record JdbcDataSourceConfig(String name, String description, String driverClassName, String jdbcUrl,
                                   String username, String password,
                                   Map<String, Object> additionalProperties) implements SourceConfig {
     ...
     * @param sourceDef the source definition from CheshireConfig
     * @return a new JdbcDataSourceConfig instance
     * @throws IllegalArgumentException if the source type is not "jdbc"
     */
    public static JdbcDataSourceConfig from(String name, CheshireConfig.Source sourceDef) {
        ...
        @SuppressWarnings("unchecked") Map<String, Object> connection = (Map<String, Object>) config.get("connection");
        ...
        return new JdbcDataSourceConfig(name, sourceDef.getDescription(), driverClassName, jdbcUrl, username, password, additionalProperties);
    }
