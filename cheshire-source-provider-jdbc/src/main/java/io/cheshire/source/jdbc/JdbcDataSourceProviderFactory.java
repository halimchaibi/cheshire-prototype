 ...
 * <p>
 * Converts raw YAML configuration ({@link CheshireConfig.Source}) into typed {@link JdbcDataSourceConfig} via adapter
 * pattern.
 * <p>
...
public class JdbcDataSourceProviderFactory
        implements SourceProviderFactory<JdbcDataSourceConfig, JdbcDataSourceProvider, CheshireConfig.Source> {
     ...
     *
     * @param config
     *            typed JDBC source configuration
