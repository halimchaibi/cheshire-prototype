 ...
 * <p>
 * Immutable record containing SQL string and parameter map for execution
 * by {@link JdbcDataSourceProvider}.
 * <p>
 * <strong>Named Parameters:</strong> Use `:paramName` syntax in SQL,
 * parameters provided in map with matching keys.
 * <p>
 ...
 * }</pre>
 *
 * @param sql    SQL query string with named parameters
