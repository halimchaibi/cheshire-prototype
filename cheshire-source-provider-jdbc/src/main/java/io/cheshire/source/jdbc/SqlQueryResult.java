 ...
 * <p>
 * Each row is represented as {@code Map<String, Object>} where keys are
 ...
 * }</pre>
 * <p>
 * <strong>Resource Management:</strong> Currently no resources to close.
 * For streaming results, consider extending with ResultSet management.
 *
 * @param rows list of result rows, each row is a column-name to value map
