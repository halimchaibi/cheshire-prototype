 ...
 *
 * <p>
 * This exception signals errors related to the manager or operation of a source, such as failures during
 * initialization, query execution, or closure. It provides a uniform way for the Cheshire query engine to handle
