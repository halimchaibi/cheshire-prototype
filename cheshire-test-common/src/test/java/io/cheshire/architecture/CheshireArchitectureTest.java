 ...
 * @since 1.0.0
 */
@AnalyzeClasses(packages = "io.cheshire", importOptions = { ImportOption.DoNotIncludeTests.class })
public class CheshireArchitectureTest {
     ...
     * <p>
     * <strong>Rationale:</strong> SPI modules define contracts that implementations must follow. They should be pure
     * interfaces with no dependencies on concrete implementations (Core, Server, Runtime).
     * <p>
     ...
     */
    @ArchTest
    static final ArchRule spi_Should_Not_Depend_On_Core_Server_Runtime = classes().that().resideInAPackage("..spi..")
     ...
     * <p>
     * <strong>Rationale:</strong> Core orchestrates the framework but should depend only on abstractions (SPIs). This
     * enables plugin-based architecture via ServiceLoader.
     * <p>
     * <strong>Allowed Dependencies:</strong>
     * <ul>
     ...
     */
    @ArchTest
    static final ArchRule core_Should_Only_Depend_On_Spi_And_Common = classes().that().resideInAPackage("..core..")
            .should().onlyDependOnClassesThat()
            .resideInAnyPackage("..core..", "..common..", "..spi..", "java..", "lombok..", "org.slf4j..",
     ...
     * <p>
     * <strong>Rationale:</strong> Server implementations handle protocol-specific concerns (HTTP, stdio) and delegate
     * to Core for business logic.
     * <p>
     * <strong>Allowed Dependencies:</strong>
     * <ul>
     ...
     */
    @ArchTest
    static final ArchRule server_Should_Only_Depend_On_Core_And_Spi = classes().that().resideInAPackage("..server..")
            .should().onlyDependOnClassesThat()
            .resideInAnyPackage("..server..", "..core..", "..common..", "..spi..", "java..", "lombok..", "org.slf4j..",
                    "com.fasterxml.jackson..", "org.eclipse.jetty..", "io.modelcontextprotocol..")
     ...
     * <p>
     * <strong>Rationale:</strong> Runtime orchestrates startup, shutdown, monitoring, and deployment. It's the only
     * module that can depend on all lower layers.
     * <p>
     * <strong>Allowed Dependencies:</strong>
     * <ul>
     ...
     */
    @ArchTest
    static final ArchRule runtime_Should_Only_Depend_On_Server_Core_Spi = classes().that()
            .resideInAPackage("..runtime..").should().onlyDependOnClassesThat()
            .resideInAnyPackage("..runtime..", "..server..", "..core..", "..common..", "..spi..", "java..", "lombok..",
     ...
     * <p>
     * <strong>Pattern:</strong> Classes ending with "QueryEngine" in query.engine packages must implement
     * {@code io.cheshire.spi.query.engine.QueryEngine}.
     * <p>
     ...
     */
    @ArchTest
    static final ArchRule queryEngines_Should_Implement_Spi = classes().that().resideInAPackage("..query.engine..")
            .and().haveSimpleNameEndingWith("QueryEngine").and().areNotInterfaces().and().areNotNestedClasses().should()
     ...
     * <p>
     * <strong>Pattern:</strong> Classes ending with "Provider" in source packages must implement
     ...
     */
    @ArchTest
    static final ArchRule source_Providers_Should_Implement_Spi = classes().that().resideInAPackage("..source..").and()
            .haveSimpleNameEndingWith("Provider").and().areNotInterfaces().and().areNotNestedClasses().should()
     ...
     * <p>
     * <strong>ServiceLoader Integration:</strong> These factories are discovered via Java's ServiceLoader mechanism for
     ...
     */
    @ArchTest
    static final ArchRule queryEngine_Factories_Should_Implement_Spi = classes().that()
            .haveSimpleNameEndingWith("Factory").and().resideInAPackage("..query.engine..").and().areNotInterfaces()
            .and().areNotNestedClasses().should().implement("io.cheshire.spi.query.engine.QueryEngineFactory")
     ...
     */
    @ArchTest
    static final ArchRule sourceProvider_Factories_Should_Implement_Spi = classes().that()
            .haveSimpleNameEndingWith("Factory").and().resideInAPackage("..source..").and().areNotInterfaces().and()
            .areNotNestedClasses().should().implement("io.cheshire.spi.source.SourceProviderFactory")
     ...
     * <p>
     * <strong>Rationale:</strong> All custom exceptions should extend Exception (either directly or via
     * RuntimeException) for consistent error handling.
     * <p>
     ...
     */
    @ArchTest
    static final ArchRule exceptions_Should_Extend_Exception = classes().that().haveSimpleNameEndingWith("Exception")
            .or().haveSimpleNameEndingWith("Error").and().resideInAPackage("io.cheshire..").should()
     ...
     * </ul>
     * <p>
     * <strong>Detection:</strong> Analyzes package slices (e.g., io.cheshire.core, io.cheshire.server) and ensures no
     * cycles exist.
     * <p>
     ...
     */
    @ArchTest
    static final ArchRule no_Circular_Dependencies = slices().matching("io.cheshire.(*)..").should().beFreeOfCycles()
     ...
     * <p>
     * <strong>Pattern:</strong> Classes ending with "Manager" should reside in manager packages and handle
     * lifecycle/registration concerns.
     * <p>
     * <strong>Examples:</strong>
     * <ul>
     ...
     */
    @ArchTest
    static final ArchRule managers_Should_Reside_In_Manager_Package = classes().that()
            .haveSimpleNameEndingWith("Manager").and().resideInAPackage("io.cheshire..").should()
            .resideInAPackage("..manager..").because("Manager classes should be organized in manager packages");

    /**
     * Ensures server-related classes use appropriate naming.
     * <p>
     * <strong>Pattern:</strong> Classes related to servers should clearly indicate their purpose through naming:
     * <ul>
     ...
     */
    @ArchTest
    static final ArchRule server_Classes_Should_Follow_Naming_Convention = classes().that()
            .haveSimpleNameContaining("Server").and().resideInAPackage("io.cheshire..").and().areNotInterfaces()
            .should().haveSimpleNameEndingWith("Server").orShould().haveSimpleNameEndingWith("ServerHandle").orShould()
            .haveSimpleNameEndingWith("ServerContainer").orShould().haveSimpleNameEndingWith("ServerFactory").orShould()
     ...
     */
    @ArchTest
    static final ArchRule config_Classes_Should_Be_Records_Or_Builders = classes().that()
            .haveSimpleNameEndingWith("Config").and().resideInAPackage("io.cheshire..").and().areNotNestedClasses()
            .and().areNotInterfaces().should().beRecords().orShould().haveSimpleNameContaining("Builder")
     ...
     * <p>
     * <strong>Rationale:</strong> Request and response objects are data carriers that should be immutable to prevent
     ...
     */
    @ArchTest
    static final ArchRule request_Response_Classes_Should_Be_Records = classes().that()
            .haveSimpleNameEndingWith("Request").or().haveSimpleNameEndingWith("Response").or()
            .haveSimpleNameEndingWith("Result").and().resideInAPackage("io.cheshire..").and().areNotNestedClasses()
            .and().areNotInterfaces().and().areNotEnums().should().beRecords()
     ...
     * <p>
     * <strong>Pattern:</strong> SPI classes should be in .spi. packages and not mixed with implementations.
     */
    @ArchTest
    static final ArchRule spi_Interfaces_Should_Be_In_Spi_Packages = classes().that().areInterfaces().and()
            .haveSimpleNameContaining("SPI").or().haveSimpleNameEndingWith("Factory").and()
            .resideInAPackage("io.cheshire..").should().resideInAPackage("..spi..")
