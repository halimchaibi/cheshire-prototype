...
public class SecurityArchitectureTest {
     ...
     * }</pre>
     * <p>
     * <strong>Cheshire Approach:</strong> All SQL generation uses DSL_QUERY templates with automatic parameter binding
     * via {@code SqlTemplateQueryBuilder}.
     */
    @ArchTest
    static final ArchRule query_Builders_Should_Not_Use_String_Concatenation = noClasses().that()
            .resideInAPackage("..query..").should().dependOnClassesThat()
            .haveFullyQualifiedName("java.lang.StringBuilder").orShould().dependOnClassesThat()
     ...
     * <p>
     * <strong>Security Best Practice:</strong> Passwords, API keys, and tokens should be externalized in configuration
     * files or environment variables, never hardcoded.
     * <p>
     * <strong>Detection:</strong> Looks for fields with names suggesting credentials.
     */
    @ArchTest
    static final ArchRule no_Hardcoded_Passwords = fields().that().haveName("password").or().haveName("PASSWORD").or()
            .haveName("apiKey").or().haveName("API_KEY").or().haveName("secret").or().haveName("SECRET").should()
            .notBeStatic().orShould().notBeFinal()
     ...
     */
    @ArchTest
    static final ArchRule security_Config_Should_Be_Immutable = classes().that().resideInAPackage("..security..").and()
            .haveSimpleNameEndingWith("Config").should().beRecords()
     ...
     * <p>
     * <strong>Pattern:</strong> Auth-related classes should be final to prevent extension attacks.
     */
    @ArchTest
    static final ArchRule auth_Classes_Should_Be_Final = classes().that().resideInAPackage("..security..").and()
            .haveSimpleNameContaining("Auth").and().areNotInterfaces().and().areNotEnums().should(beFinal())
     ...
     */
    @ArchTest
    static final ArchRule sensitive_Data_Should_Use_Immutable_Collections = noClasses().that()
            .resideInAPackage("..security..").and().haveSimpleNameContaining("Credential").or()
            .haveSimpleNameContaining("Token").should().accessClassesThat()
            .haveFullyQualifiedName("java.util.ArrayList").orShould().accessClassesThat()
